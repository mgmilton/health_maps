...
VCR.configure do |config|
  ...
  config.filter_sensitive_data('<twitter_consumer_api_key>') {ENV["TWITTER_CONSUMER_API_KEY"]}
  config.filter_sensitive_data('<twitter_consumer_secret_api_secret>') {ENV["TWITTER_CONSUMER_SECRET_API_SECRET"]}
